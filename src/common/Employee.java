...
import org.apache.commons.lang3.builder.CompareToBuilder;//still have to have a compareTo method
//need to download the code from website(zip file). need .jar file(s) (like a zip file--compressed, contains compiled classes)
//link it to project. go to proj in netbeans, find folder called libraries. right click, add jar, navigate to folder with .jar file
/**
